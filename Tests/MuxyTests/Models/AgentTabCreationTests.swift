...
struct AgentTabCreationTests {
    ...
    func appStateCreateAgentTabRecordsHostdLaunchEnvironment() async throws {
        ...
        #expect(request.environment["ROOST_PANE_ID"] == pane.id.uuidString)
        #expect(request.environment["ROOST_PROJECT_ID"] == projectID.uuidString)
        #expect(request.environment["ROOST_WORKTREE_ID"] == worktreeID.uuidString)
