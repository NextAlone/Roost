...
Roost depends on libghostty compiled as a static library inside `GhosttyKit.xcframework/`. The xcframework is built and released via GitHub Actions on the [muxy-app/ghostty](https://github.com/muxy-app/ghostty) fork inherited from the Muxy baseline.
